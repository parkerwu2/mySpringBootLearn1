...
public class BookController {
    ...
    /**
     * this.rabbitTemplate.convertAndSend(RabbitConfig.REGISTER_DELAY_EXCHANGE, RabbitConfig.DELAY_ROUTING_KEY, book); 对应
     */
    @GetMapping
    public void defaultMessage() {
        ...
        System.out.printf("[发送时间] - [{}]", LocalDateTime.now());
    }
}
